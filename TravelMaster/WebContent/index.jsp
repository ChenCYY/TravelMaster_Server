  ...
  <header>
      ...
      <div class="container templatemo_container">
        <div class="row">
          <div class="col-sm-3 col-md-3">
            <div class="logo">
              <a  href="http://sc.chinaz.com/"><img src="images/templatemo_logo.png" alt="logo"></a>
            </div>
          ...
          <div class="col-sm-9 col-md-9 templatemo_col9">
            ...
            <nav class="mainMenu">
              <ul class="nav">
                <li><a class="menu" href="#templatemo_home">首页</a></li>
                
                <li><a class="menu" href="#templatemo_portfolio">热门景点</a></li>
	            <li><a class="menu" href="#templatemo_blog">论坛</a></li>
	               
                <li><a class="menu" href="rankinglists.jsp">排行榜</a></li>
                
                <c:if test="${empty sessionScope.user }">
                	<li><a class="menu" href="login.jsp">注册/登陆</a></li>
                </c:if>
                <c:if test="${!empty sessionScope.user }">    
                	<li><a class="menu" href="mytravellists.jsp">个人中心</a></li>
                </c:if>
              </ul>
            </nav>
            </div>
    ...
    <div class="clear">
      <form method="post" name="form1" id="form1" accept-charset="UTF-8">
        <div  id="slider"  class="nivoSlider templatemo_slider"><a href="#"><img src="images/slider/img_1_blank.jpg" alt="slide 1" /></a> <a href="#"><img src="images/slider/img_2_blank.jpg" alt="slide 2" /></a> <a href="#"><img src="images/slider/img_3_blank.jpg" alt="slide 3" width="951" height="316" /></a></div></form>
      <p>&nbsp; </p>
    </div>
  </header>
    ...
    <div class="templatemo_portfolio" id="templatemo_portfolio">
        	<h2>热门景点</h2>
            <p>根据多方面指标，为您精选度假、旅游胜地，让您不虚此行</p>
            ...
            <a class="btn btn-large btn-primary" href="jsp/ShowPicture.jsp">更多</a>
    </div>
    <!--Our Portfolio End-->
    <div class="clear"></div>
    <!--Our Blog Start-->
    <div class="templatemo_blog" id="templatemo_blog">
        	...
        	<p><a href="ShowPostsServlet">进入论坛>></a></p>
        <div class="clear"></div>
        <div class="container">
       		<div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12">
	...
	<!-- Bottom Start -->
	<div class="copyrights">Collect from <a href="http://sc.chinaz.com/" >Website Template</a></div>
    <div class="clear"></div>
    <div class="templatemo_reasonbg">
    	<h2>为什么选择我们？</h2>
       		<p>根据您的需要、兴趣，为您私人定制旅行，更精确、更贴心.</p>
            <div class="clear height10"></div>
	        <div class="fa fa-bell-o"></div>
            <div class="fa fa-tablet"></div>
            <div class="fa fa-lock"></div>
			<div class="clear height20"></div>
            <a class="btn btn-large btn-primary" href="#">联系我们</a>
    </div>
    <div class="clear"></div>
    <div class="templatemo_bottom">
    	<div class="container">
        	<div class="row">
            	<div class="left">机动的晓蜗牛 &copy; 2014.出品.</div>
        	</div>
        </div>
    </div>
    <!-- Bottom End -->
