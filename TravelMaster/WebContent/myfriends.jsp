...
<body class="clearfix with-menu with-shortcuts">
	...
	<c:if test="${empty requestScope.lstHotAttractions }">
		<script>
			window.location = "ShowRelationsServlet";
		</script>
	</c:if>
            ...
            <table class="table responsive-table" id="sorting-advanced">
				<thead>
					<tr>
						...
						<th align="center" scope="col">好友名称</th>
						<th width="15%" align="center" class="align-center hide-on-mobile" scope="col">好友注册时间</th>
					  <th width="10%" align="center" class="align-center hide-on-mobile-portrait" scope="col">Ta的性别</th>
					  <th width="20%" align="center" class="hide-on-tablet" scope="col">Ta的个性签名</th>
				...
				<%int count; %>
				<%count=0; %>
					<c:forEach items="${ requestScope.lstShowRelations }" var="showrel">
					<tr>
						
						<th><%=count+1 %></th>
						<td>${ showrel.uname }</td>
						<td>${ showrel.regdate }</td>
						<td>${ showrel.usex }</td>
					  	<td>${ showrel.umark }</td>
                        <td class="low-padding align-center">
                        	<button type="button" class="button compact icon-gear" onClick="return openConfirm(${ showrel.reid})">
			            		取消关注
			            	</button>
	...
	<ul id="shortcuts" role="complementary" class="children-tooltip tooltip-right">
		...
		<li class="current"><a href="myfriends.jsp" class="shortcut-contacts" title="我的关注">我的关注</a></li>	
