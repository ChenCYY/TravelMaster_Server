...
<body class="full-page-wizard">
	...
	<form method="post" action="ChangeTravellistsServlet" class="block wizard same-height" id="form">

		<h3 class="block-title">管理行程表</h3>

		<fieldset class="wizard-fieldset fields-list">
        <legend class="legend">修改行程表</legend>
			<div class="field-block">
				<h4>嗨！</h4>
				<p>请在这儿修改行程表吧:</p>
			</div>
			<!-- 隐藏域传值 -->
			<input type="hidden" name="tid" id="tid" value="${ requestScope.travellist.tid }" >
			...
			<div class="field-block button-height">
				...
				<input type="text" name="startplace" id="startplace" value="${ requestScope.travellist.departure }" class="input validate">
		    </div>
			
			<div class="field-block button-height">
				<label for="destination" class="label"><b>目的地</b></label>
				<input type="text" name="destination" id="destination" value="${ requestScope.travellist.way }" readonly="readonly" class="input validate">
		    </div>
						...
						<div class="left-column">
							<p class="button-height">
								<span class="input">
									...
									<input type="text" name="datepicker" id="datepicker" class="input-unstyled datepicker" value="${ requestScope.travellist.traveldate }">
								</span>
							</p>
            ...
            <div class="field-block button-height">
                ...
                <label>
                       <textarea name="mark" id="mark" cols="45" rows="5">${ requestScope.travellist.mark }</textarea>  
                 </label>		  
          </div>
	...
	{
		$.modal.confirm('确定修改这个旅程吗?', function()
		{
			form.submit();
		}, function()
		{
